        ...
        <div className="relative max-w-7xl mx-auto px-4 pt-20 ">
          ...
          <div className="text-center mb-6">
            <p className="text-lg font-bold mb-2">
              Total {(stats.totalPhotos / 1000).toFixed(0)}k high resolution
              photos of {stats.totalPlaces} places uploaded by{" "}
              {stats.totalUsers} users
            </p>
            <p className="text-base font-bold">
              Get paid 1 rs / .01 USD for uploading 4 photos in your proto
              wallet
            </p>
          </div>

          {/* Navigation Links - Styled like in image */}
          <div className="text-center mb-6">
          ...
          <div className="relative z-10  justify-center h-full px-10 py-4">
            <div className="text-center text-white p-6 bg-black bg-opacity-65 rounded-md">
              ...
              <p className="text-lg md:text-xl">
                Transform your travel memories into rewards. Upload stunning
                photos, earn real money, and inspire explorers worldwide.
              </p>
            </div>
          </div>
        </div>
